...
public class Queries {
     ...
     * @param localDateTime the creation timestamp (used if creating a new build)
    ...
    public static void saveBuild(
        ...
        context.transaction(config -> {
            ...
            if (buildIdResults.isEmpty()) {
                ...
                buildMetaRecord.setCreatedAt(localDateTime);
     ...
     */
    public static @NonNull List<String> getLatestSupporting(DSLContext context, String format) {
        ...
        context.transaction(configuration -> {
            ...
            Table<Record3<String, Integer, Integer>> inner = dsl.select(
                    ...
                    .from(BUILD_META
                            ...
                            .on(BUILD_VERSION.ID.eq(BUILD_SUPPORTED_FORMATS.BUILD_VERSION_ID)))
                    .where(BUILD_SUPPORTED_FORMATS.FORMAT_NAME.eq(inline(format))).asTable("ranked");
